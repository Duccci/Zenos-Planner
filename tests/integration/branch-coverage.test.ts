...
describe('FunctionRegistry - branch coverage', () => {
  ...
  it('list returns all registered functions', () => {
    registry.register('fn_a', () => null, {
      description: 'a', parameters: [], returnType: 'null', schema: z.object({}),
    })
    registry.register('fn_b', () => null, {
      description: 'b', parameters: [], returnType: 'null', schema: z.object({}),
    })
  ...
  it('get returns registered function', () => {
    registry.register('fn_get_test', () => null, {
      description: 'get test', parameters: [], returnType: 'null', schema: z.object({}),
    })
  ...
  it('getByCategory returns gate functions', () => {
    registry.register('gates_list', () => null, {
      description: 'gates list', parameters: [], returnType: 'null', schema: z.object({}),
    })
    registry.register('gates_show', () => null, {
      description: 'gates show', parameters: [], returnType: 'null', schema: z.object({}),
    })
    registry.register('req_action', () => null, {
      description: 'req action', parameters: [], returnType: 'null', schema: z.object({}),
    })
  ...
  it('getByCategory returns template functions', () => {
    registry.register('getTemplate', () => null, {
      description: 'get template', parameters: [], returnType: 'null', schema: z.object({}),
    })
    registry.register('loadAllTemplates', () => null, {
      description: 'load all templates', parameters: [], returnType: 'null', schema: z.object({}),
    })
  ...
  it('getByCategory returns general functions', () => {
    registry.register('status', () => null, {
      description: 'status', parameters: [], returnType: 'null', schema: z.object({}),
    })
    registry.register('init', () => null, {
      description: 'init', parameters: [], returnType: 'null', schema: z.object({}),
    })
  ...
  it('register overwrites existing function with same name', () => {
    registry.register('fn_overwrite', () => 'first', {
      description: 'first', parameters: [], returnType: 'string', schema: z.object({}),
    })
    registry.register('fn_overwrite', () => 'second', {
      description: 'second', parameters: [], returnType: 'string', schema: z.object({}),
    })
  ...
  it('invoke passes validated params to implementation', async () => {
    ...
    registry.register(
      'test_fn_params_pass',
      (params) => { receivedParams = params; return 'ok' },
      {
