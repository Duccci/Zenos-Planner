...
- Completion Notes: Both solitary proposals fully implemented and committed (b71b31e). guardrails.ts constants, PreReviewSchema, scope validators, CLI tool invoker.