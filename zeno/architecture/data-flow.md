...
flowchart TD
    ...
    class DeepAnalysis,ZenoAlgo,GenerateGates,GenProjectReqs,StoreProjectReqs,DecomposeReqs,StoreGateReqs,GenArchitecture,StoreArch implemented
    class DetectRepos in_progress
    class Replan,GenProposals,StoreProposals,AutoChecks,Replan2,StartWorktree,ValidateImplementation,RejectProposal,GitIntegration planned
```