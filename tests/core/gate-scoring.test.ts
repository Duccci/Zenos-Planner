...
import { calculateConfidence } from '../../src/core/gate-scoring.ts'
import { Gate, DecompositionContext } from '../../src/core/types.ts'
...
describe('calculateConfidence', () => {
  ...
  it('should reduce confidence for gates with many dependencies', () => {
    const fewDependenciesGate: Gate = {
      id: 'gate-01',
      name: 'Few deps',
      description: 'Simple',
      objectives: [],
    ...
    const manyDependenciesGate: Gate = {
      id: 'gate-02',
      name: 'Many deps',
      description: 'Complex',
      objectives: [],
    ...
    const fewConfidence = calculateConfidence(fewDependenciesGate, context)
    const manyConfidence = calculateConfidence(manyDependenciesGate, context)

    expect(fewConfidence).toBeGreaterThan(manyConfidence)
  })
})
