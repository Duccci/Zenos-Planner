...
2. **Reference `.zeno/docs/PROJECT_PRD.md`** - Single source of truth for:
...
3. **Check architecture documentation** - Visual system overview:
   - `.zeno/docs/architecture/system-overview.md` - Component architecture
   - `.zeno/docs/architecture/gate-lifecycle.md` - State machine
   - `.zeno/docs/architecture/data-flow.md` - End-to-end flow
   - `.zeno/docs/architecture/gate-roadmap.md` - Gate roadmap
...
- Use `#a3f9c2d1` instead of full file paths
...
zeno gates complete <gate-id>       # Mark gate complete
...
1. **Always use hash references** in communications (`#a3f9c2d1` not file paths)
...
| Project PRD | `.zeno/docs/PROJECT_PRD.md` |
