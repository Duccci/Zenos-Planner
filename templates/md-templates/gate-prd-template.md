...
zeno:
  ...
  milestones: []       # optional: [1, 'MVP'] | ['Post-MVP'] | ['Deferred'] | ['Backup'] | ['May Demo']
---
...
**Milestones**: [e.g. 1, MVP | Post-MVP | Deferred | Backup | custom]
**Created**: [YYYY-MM-DD]
**Sequence**: [X of Y]
...
<!-- Generated by /zeno-proposal when proposals are created. Shows execution order: left = runs first, right = runs later. Arrow A --> B means A must complete before B. Node IDs are camelCase slugs derived from proposal titles — never raw hashes. -->

```mermaid
graph LR
    prop01["01 Proposal Name"]
    prop02["02 Proposal Name"]
    prop01 --> prop02
```
