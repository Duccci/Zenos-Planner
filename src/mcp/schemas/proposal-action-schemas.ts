 ...
 */
export const isProposalListAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'list' }> =>
  input.action === 'list'

export const isProposalShowAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'show' }> =>
  input.action === 'show'

export const isProposalCreateAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'create' }> =>
  input.action === 'create'

export const isProposalValidateAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'validate' }> =>
  input.action === 'validate'

export const isProposalApproveAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'approve' }> =>
  input.action === 'approve'

export const isProposalRejectAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'reject' }> =>
  input.action === 'reject'

export const isProposalStartAction = (input: ProposalActionInput): input is Extract<ProposalActionInput, { action: 'start' }> =>
  input.action === 'start'
