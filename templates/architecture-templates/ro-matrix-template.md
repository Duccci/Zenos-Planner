# R&O Matrix: [Project / Initiative Name]

**Project**: [Project or Initiative Name]
**Scope**: [Brief one-line description of what this matrix covers, e.g., "Full project lifecycle" or "Phase 2 delivery"]
**Created**: [YYYY-MM-DD]
...
digraph RiskOpportunityHeatmap {
    rankdir=LR;
    bgcolor=transparent;
    label="Risk/Opportunity Heatmap: [Project Name]";
    labelloc=top;
    fontsize=14;
    margin="0.1,0.05";
    ...
    matrix [shape=plaintext, label=<
        <TABLE BORDER="1" CELLBORDER="1" CELLSPACING="0" CELLPADDING="6" ALIGN="CENTER">
            ...
            <TR>
                ...
                <TD BGCOLOR="#1a5ba6"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#2f6fb3"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#4a8cc7"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
                ...
                <TD BGCOLOR="#f7b344"><FONT POINT-SIZE="9"> </FONT></TD>
            ...
            <TR>
                ...
                <TD BGCOLOR="#2868b0"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#3d7dbf"><B><FONT COLOR="white" POINT-SIZE="9">O-001</FONT></B></TD>
                <TD BGCOLOR="#589ed2"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
                ...
                <TD BGCOLOR="#f9c268"><FONT POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#e5a03d"><B><FONT COLOR="white" POINT-SIZE="9">R-001</FONT></B></TD>
            ...
            <TR>
                ...
                <TD BGCOLOR="#3875ba"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
                ...
                <TD BGCOLOR="#fff4d6"><FONT POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#fce4b3"><FONT POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#edb454"><FONT POINT-SIZE="9"> </FONT></TD>
                <TD BGCOLOR="#c64242"><FONT COLOR="white" POINT-SIZE="9"> </FONT></TD>
            </TR>
            <TR>
                ...
                <TD BGCOLOR="#fffef0"><FONT POINT-SIZE="9"> </FONT></TD>
...
| -- | -------- | ----------- | - | - | ----- | ------------------- | ----- | ------ | ----------- |
| R-001 | Technical | [What could go wrong and why] | 3 | 4 | 12 | [Steps to reduce likelihood or impact] | [Name/Role] | `open` \| monitoring \| mitigated \| closed \| realized | [YYYY-MM-DD] |
| R-002 | | | | | | | | | |
| R-003 | | | | | | | | | |
...
| -- | -------- | ----------- | - | - | ----- | --------------------- | ----- | ------ | ----------- |
| O-001 | Technical | [What could go right and why] | 3 | 4 | 12 | [Steps to increase likelihood or maximize benefit] | [Name/Role] | `identified` \| pursuing \| realized \| deferred \| declined | [YYYY-MM-DD] |
| O-002 | | | | | | | | | |
| O-003 | | | | | | | | | |
...
<!-- Document risks and opportunities that are directly linked. -->

| Risk ID | Opportunity ID | Relationship | Notes |
| ------- | -------------- | ------------ | ----- |
| R-001 | O-001 | [Mitigating R-001 enables O-001] | |
...
| ---- | -------- | ------------ | ----------- |
| [YYYY-MM-DD] | [Name/Role] | [Created / Updated R-001 status / Added O-002] | [YYYY-MM-DD] |
